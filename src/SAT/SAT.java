...
public class SAT extends ProblemDomain {
	...
	public static String[] getFileName() {
        ...
        String path = System.getProperty("user.dir") + "/instances/sat"; //path
        System.out.println("line50"+System.getProperty("user.dir"));
...
//        	System.out.println("SAT line59");
        	getAllFiles(f, instanceStack);
        }
//        System.out.println("SAT line62"+path);
...
//        	System.out.println("SAT line74 "+fa[i]);
        	if (fa[i].isDirectory()) {
        		getAllFiles(fa[i], instanceNameStack);	
        	}
        	else {
            	if (!fa[i].getName().equals(".DS_Store") && !fa[i].getName().substring(0,4).equals("read")) {
            		int nameIndex = fa[i].getParent().indexOf("sat");
//            		System.out.println(fa[i].getParent());
            		String rootName = fa[i].getParent().substring(nameIndex+"sat".length()+1);
//            		System.out.println("SAT 85"+rootName);
...
//            		System.out.println("SAT line87 "+resultName);
...
//				System.out.println("SAT 509 "+heuristicCallRecord[heuristicID]);
...
//			System.exit(-1);
//		}
//		System.out.println("Loading Instance " + "instances/sat/" + folder);
...
//	}// end loadinstance method
	...
	public void loadInstance(int instanceID) {
		...
		if (instanceID < instanceNames.length) {
			ins = System.getProperty("user.dir") + "/instances/sat/" + instanceNames[instanceID];
		}
		else {
			System.err.println("instance " + ins + "does not exist");
			System.exit(-1);
		}
		System.out.println("SAT.java line787: the current instance is: " + ins);
