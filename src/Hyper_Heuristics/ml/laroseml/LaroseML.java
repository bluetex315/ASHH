package Hyper_Heuristics.ml.laroseml;
...
public class LaroseML extends HyperHeuristic
{
   ...
   private boolean diversification()
   {
      ...
      System.out.println("ML 62 heuristic "+_divHeu.get(heuInd).index());
      System.out.println("ML 63 prev obj "+_problem.getFunctionValue(CUR_IND));
      _problem.applyHeuristic(_divHeu.get(heuInd).index(),
                              CUR_IND,
                              CUR_IND);
      System.out.println("ML 67 curr obj "+_problem.getFunctionValue(CUR_IND));
   ...
   public boolean localSearch()
   {
      ...
      while (true)
      {
         ...
         System.out.println("ML 151 heuristic "+_intenHeu.get(heuristic).index());
         System.out.println("ML 152 prev obj "+_problem.getFunctionValue(CUR_IND));
         double objValue
            = _problem.applyHeuristic(_intenHeu.get(heuristic).index(),
                                      CUR_IND,
                                      CUR_IND);
         System.out.println("ML 157 curr obj "+_problem.getFunctionValue(CUR_IND));
