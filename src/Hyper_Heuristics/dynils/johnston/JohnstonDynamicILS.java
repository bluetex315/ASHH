...
public class JohnstonDynamicILS extends JohnstonAbstractILS {
	...
	public JohnstonDynamicILS(long seed) {
		this(seed, 20);
	}
	
	public JohnstonDynamicILS(long seed, int nPurturbationStrengths) {
		super(seed, nPurturbationStrengths);
	}
	...
	public String toString() {
		return "Dynamic Iterated Local Search";
	}
