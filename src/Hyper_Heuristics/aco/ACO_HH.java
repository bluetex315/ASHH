	...
	*/
	...
	public void solve(ProblemDomain problemon) {
		...
		while(!hasTimeExpired()){ //Verifica fin del tiempo.
			...
			System.out.println("ACO 127 quality of init "+iniFitness);
			...
			for(int j=0;j<m;j++){
				...
				for(int k=0;k<n;k++){
					...
					System.out.println("ACO 146 applying heuristics: "+caminos[j][k][0]);
					System.out.println("ACO 147 quality of hh "+newFitness);
