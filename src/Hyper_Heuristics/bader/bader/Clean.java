package Hyper_Heuristics.bader.bader;
...
public class Clean extends HyperHeuristic {
	...
	int     memSize;
        ...
        public boolean cross(int loc1) {
            ...
            System.out.println("Clean 112 hh: "+crossList[rng.nextInt(crossList.length)]);
            System.out.println("Clean 113 prev q "+problem.getFunctionValue(loc1));
            System.out.println("Clean 114 prev q "+problem.getFunctionValue(loc2));
            objList[newLoc] = problem.applyHeuristic(crossList[rng.nextInt
                    (crossList.length)], loc1, loc2, newLoc); 
            System.out.println("Clean 117 curr q"+problem.getFunctionValue(newLoc));
        ...
        public boolean ruin(int hToUse, int loc) {
            ...
            do{
                ...
                System.out.println("Clean 129 hh: "+hToUse);
                System.out.println("Clean 130 prev q "+problem.getFunctionValue(loc));
                objList[newLoc] = problem.applyHeuristic(hToUse, loc, newLoc);
                System.out.println("Clean 131 curr q "+problem.getFunctionValue(newLoc));
                if (isGlobalBest(objList[newLoc], newLoc))
                {
            ...
            System.out.println("clean 156: "+globalImproved);
        ...
        public boolean mutate(int hToUse, int loc) {
            ...
            do{
                newLoc = selectInvToReplaceNotHead();
                System.out.println("Clean 160 hh: "+hToUse);
                System.out.println("Clean 161 prev q "+problem.getFunctionValue(loc));
                objList[newLoc] = problem.applyHeuristic(hToUse, loc, newLoc);
                System.out.println("Clean 163 curr q "+problem.getFunctionValue(newLoc));
                if (isGlobalBest(objList[newLoc], newLoc))
                {
        ...
        public boolean improveH(int i/*hToUse*/, int memLoc) {
            ...
            if (performance[i]>=minPerformance)
            {
                ...
                do
                {
                    ...
                    System.out.println("Clean 201 hh: "+improveList[i]);
                    System.out.println("Clean 202 prev q "+problem.getFunctionValue(memLoc));
                    objList[tempMem] =  problem.applyHeuristic(improveList[i], 
                            memLoc, tempMem);
                    System.out.println("Clean 203 curr q "+problem.getFunctionValue(tempMem));
