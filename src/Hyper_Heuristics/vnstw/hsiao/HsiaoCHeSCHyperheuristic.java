package Hyper_Heuristics.vnstw.hsiao;
...
//		System.out.println("Initialize\t" + this.getElapsedTime() +"ms");
		...
		if(this.getElapsedTime() < 10000){
			...
			for(int k : heuristicsL.keyset){
				System.out.println("VNS-TW 123 heuristic "+k);
				System.out.println("VNS-TW 124 prev obj "+problem.getFunctionValue(i));
				currentValue[0] = problem.applyHeuristic(k, i, 0);
				System.out.println("VNS-TW 126 curr obj "+problem.getFunctionValue(0));
				for(int j = 0; j < 3; j++){
					System.out.println("VNS-TW 128 heuristic "+k);
					System.out.println("VNS-TW 129 prev obj "+problem.getFunctionValue(i));
					currentValue[2] = problem.applyHeuristic(k, i, 2);
					System.out.println("VNS-TW 131 curr obj "+problem.getFunctionValue(2));
...
//		System.out.println(elapsedTime + "ms/" + this.getElapsedTime() + "ms");
		...
		for(int k : heuristicsRM.keyset){
			startTime = System.currentTimeMillis();
			System.out.println("VNS-TW 156 heuristic "+k);
			System.out.println("VNS-TW 157 prev obj "+problem.getFunctionValue(offset));
			currentValue[2] = problem.applyHeuristic(k, offset, 2);
			System.out.println("VNS-TW 159 curr obj "+problem.getFunctionValue(2));
			elapsedTime = System.currentTimeMillis() - startTime;
...
//			startTime2 = System.currentTimeMillis();
			...
			System.out.println("VNS-TW 202 heuristic "+heuristicToApply);
			System.out.println("VNS-TW 203 prev obj "+problem.getFunctionValue(1));
			currentValue[2] = problem.applyHeuristic(heuristicToApply, 1, 2);
			System.out.println("VNS-TW 205 curr obj "+problem.getFunctionValue(2));
//			System.setOut(outView);
...
//		System.setOut(outLocal);
		...
		for(int i = 0; i < currentLS; i++){
			System.out.println("VNS-TW 253 heuristic "+heuristicToApply);
			System.out.println("VNS-TW 254 prev obj "+problem.getFunctionValue(index));
			currentValue[0] = problem.applyHeuristic(heuristicToApply, index, 0);
			System.out.println("VNS-TW 256 curr obj "+problem.getFunctionValue(0));
...
//				+ " Iteration=" + heuristicsRM.getIterationCount());
	...
	public void localSearchForInitialization(){
		...
		for(int i = 0; i < heuristicsL.size(); i++){
			...
			System.out.println("VNS-TW 414 heuristic "+heuristicToApply);
			System.out.println("VNS-TW 415 prev obj "+problem.getFunctionValue(1));
			currentValue[1] = problem.applyHeuristic(heuristicToApply, 1, 1);
			System.out.println("VNS-TW 417 curr obj "+problem.getFunctionValue(1));
			while(currentValue[1] < initialValue){
				initialValue = currentValue[1];
				System.out.println("VNS-TW 420 heuristic "+heuristicToApply);
				System.out.println("VNS-TW 421 prev obj "+problem.getFunctionValue(1));
				currentValue[1] = problem.applyHeuristic(heuristicToApply, 1, 1);
				System.out.println("VNS-TW 424 curr obj "+problem.getFunctionValue(1));
			}
		}
	}
