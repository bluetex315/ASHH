...
package Hyper_Heuristics.giss.acuna;
...
public class GISS extends HyperHeuristic {
    ...
    protected void solve(ProblemDomain problem) {
        ...
        while (!hasTimeExpired()) {
            ...
            if (crossover_flag) {
            	System.out.println("GISS 90 hh: "+heuristic_to_apply);
                System.out.println("GISS 91 prev q "+problem.getFunctionValue(0));
                System.out.println("GISS 92 prev q "+problem.getFunctionValue(1));
                new_obj_function_value = problem.applyHeuristic(heuristic_to_apply, 0, 1, 2);
                System.out.println("GISS 94 curr q "+problem.getFunctionValue(2));
            } else {
            	System.out.println("GISS 96 hh: "+heuristic_to_apply);
                System.out.println("GISS 97 prev q "+problem.getFunctionValue(0));
                new_obj_function_value = problem.applyHeuristic(heuristic_to_apply, 0, 2);
                System.out.println("GISS 99 prev q "+problem.getFunctionValue(2));
            }
            ...
            if (iterator > limite_iteraciones) {
                ...
                if (ruin_array.length > 0) {
                	System.out.println("GISS 138 hh: "+ruin_array[mt_random.nextInt(ruin_array.length)]);
                    System.out.println("GISS 139 prev q "+problem.getFunctionValue(0));
                    current_obj_function_value = problem.applyHeuristic(ruin_array[mt_random.nextInt(ruin_array.length)], 0, 0);
                    System.out.println("GISS 141  q "+problem.getFunctionValue(0));
                    
                    System.out.println("GISS 143 hh: "+mutation_array[mt_random.nextInt(mutation_array.length)]);
                    System.out.println("GISS 144 prev q "+problem.getFunctionValue(0));
                    current_obj_function_value = problem.applyHeuristic(mutation_array[mt_random.nextInt(mutation_array.length)], 0, 0);
                    System.out.println("GISS 146  q "+problem.getFunctionValue(0));
                    
                }else{
                	System.out.println("GISS 149 hh: "+mutation_array[mt_random.nextInt(mutation_array.length)]);
                    System.out.println("GISS 150 prev q "+problem.getFunctionValue(0));
                    current_obj_function_value = problem.applyHeuristic(mutation_array[mt_random.nextInt(mutation_array.length)], 0, 0);
                    System.out.println("GISS 152  q "+problem.getFunctionValue(0));
                }
