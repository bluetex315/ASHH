...
abstract public class BasicProblemDomain<T extends BasicSolution<P>, P extends BenchmarkInfo> extends ProblemDomain{
	...
	public BasicProblemDomain(long seed) {
		...
		System.out.println("Basic Problem Domain 42 benchmarks got--------------");
	...
	public void loadInstance(int pi) {
		...
		System.out.println("BasicProblemDomain line242: "+"loading instances--------- "+pi);
		System.out.println("BasicProblemDomain line242: "+"loading instances--------- "+benchmarks[pi]);
		instance = benchmarks[pi].load();
		System.out.println("BasicProblemDomain line244: "+"current instances, "+benchmarks[pi]);
