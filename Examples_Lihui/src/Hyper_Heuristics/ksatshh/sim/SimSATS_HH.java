package Hyper_Heuristics.ksatshh.sim;
	...
	public void solve(ProblemDomain problem) {
		...
		while (!hasTimeExpired()) {
			...
			if (numHeuristics > 0) {
				...
				System.out.println("KSATS-HH 181 heuristic "+heuristic_to_apply);
				System.out.println("KSATS-HH 182 prev obj "+problem.getFunctionValue(0));
				problem.applyHeuristic(heuristic_to_apply, 0, 1);
				System.out.println("KSATS-HH 184 curr obj "+problem.getFunctionValue(1));
