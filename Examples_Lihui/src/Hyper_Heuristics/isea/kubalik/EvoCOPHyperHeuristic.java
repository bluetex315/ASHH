package Hyper_Heuristics.isea.kubalik;
...
//        for(int i=0; i < populationAS.size(); i++){
    ...
    public int testTimeComplexity(){
        ...
        if (EvoCOPHyFlexManager.local_search_heuristics != null){
            ...
            System.out.println("ISEA 211 heuristic "+name);
			System.out.println("ISEA 212 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            double value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
            System.out.println("ISEA 214 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            ...
            System.out.println("ISEA 219 heuristic "+name);
			System.out.println("ISEA 220 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
            System.out.println("ISEA 222 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            if(value < EvoCOPHyFlexManager.problem.getFunctionValue(0))
               EvoCOPHyFlexManager.problem.copySolution(1, 0);
            //--- 3. LLH
            name = EvoCOPHyFlexManager.local_search_heuristics[generator.nextInt(EvoCOPHyFlexManager.local_search_heuristics.length)];
            System.out.println("ISEA 227 heuristic "+name);
			System.out.println("ISEA 228 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
			System.out.println("ISEA 230 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            if(value < EvoCOPHyFlexManager.problem.getFunctionValue(0))
               EvoCOPHyFlexManager.problem.copySolution(1, 0);
        }
        else if(EvoCOPHyFlexManager.mutation_heuristics != null)
        {
            ...
            System.out.println("ISEA 238 heuristic "+name);
			System.out.println("ISEA 239 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            double value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
			System.out.println("ISEA 241 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            if(value < EvoCOPHyFlexManager.problem.getFunctionValue(0))
               EvoCOPHyFlexManager.problem.copySolution(1, 0);
            //--- 2. LLH
            name = EvoCOPHyFlexManager.mutation_heuristics[generator.nextInt(EvoCOPHyFlexManager.mutation_heuristics.length)];
            System.out.println("ISEA 246 heuristic "+name);
			System.out.println("ISEA 247 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
			System.out.println("ISEA 249 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            if(value < EvoCOPHyFlexManager.problem.getFunctionValue(0))
               EvoCOPHyFlexManager.problem.copySolution(1, 0);
            //--- 3. LLH
            name = EvoCOPHyFlexManager.mutation_heuristics[generator.nextInt(EvoCOPHyFlexManager.mutation_heuristics.length)];
            System.out.println("ISEA 254 heuristic "+name);
			System.out.println("ISEA 255 prev obj "+EvoCOPHyFlexManager.problem.getFunctionValue(0));
            value = EvoCOPHyFlexManager.problem.applyHeuristic(name, 0, 1);
			System.out.println("ISEA 257 curr obj "+EvoCOPHyFlexManager.problem.getFunctionValue(1));
            if(value < EvoCOPHyFlexManager.problem.getFunctionValue(0))
               EvoCOPHyFlexManager.problem.copySolution(1, 0);
        }
        System.out.println("ISEA 261 "+EvoCOPHyFlexManager.problem.getBestSolutionValue());
