package Hyper_Heuristics.avegnep.urli;
...
public class Urli_AVEG_NeptuneHyperHeuristic extends HyperHeuristic {
	...
	protected void solve(ProblemDomain problemDomain) {
		...
		for( int agent = 0; agent < agents; agent++) {
			...
			System.out.println("avegnep 78: "+problemDomain.getFunctionValue(agent));
			state[agent] = 0;
		...
		while(!hasTimeExpired()) {
			...
			for(int agent = 0; agent < agents; agent++) {
				...
				System.out.println("avegnep 108 hh: "+heuristicIndex);
//				System.out.println("avegnep 109 prev obj: "+problemDomain.getFunctionValue(agent));
				System.out.println("avegnep 109 prev obj: "+problemDomain.getFunctionValue(chooseBestPartner(agent)));
				System.out.println("avegnep function value: "+functionValue[agent]);
				functionValue[agent] = problemDomain.applyHeuristic( heuristicIndex, agent, chooseBestPartner(agent), agent );
				System.out.println("avegnep function value: "+functionValue[agent]);
				System.out.println("avegnep 109 curr obj: "+problemDomain.getFunctionValue(agent));
